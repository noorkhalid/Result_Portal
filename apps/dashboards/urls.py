...
from dashboards.views.result_batch_views import (
    ...
    batch_notifications,
    batch_notification_number_suggestion,
...
urlpatterns = [
    ...
    path(
        "admin-dashboard/result-batches/<int:pk>/notifications/number-suggestion/",
        batch_notification_number_suggestion,
        name="admin_batch_notification_number_suggestion",
    ),
